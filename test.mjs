// Import the ES Module version of AsyncLRUCache
import AsyncLRUCache from './dist/esm/main-esm.js';

// Comprehensive tests for AsyncLRUCache (ESM version)
(async () => {
  console.log('Starting Full ES Module Tests...');
  ...
  console.log('Full ES Module Tests Completed!');
})();
