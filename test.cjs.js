const AsyncLRUCache = require('./dist/cjs/main-cjs'); // Import the CommonJS version

(async () => {
  console.log('Starting CommonJS Batch Eviction Tests...');
  ...
  console.log('Batch Eviction CommonJS Tests Completed!');
})();
